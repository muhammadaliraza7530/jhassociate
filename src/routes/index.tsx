...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "JH Associates — Civil Construction & Interior Design" },
      {
        name: "description",
        content:
          "JH Associates delivers civil construction, architecture and interior design for distinctive homes and spaces.",
      },
      { property: "og:title", content: "JH Associates — Civil & Interior" },
      {
        property: "og:description",
        content: "Civil construction and interior design, planned and delivered by one team.",
      },
  ...
  return (
    <section className="relative flex min-h-[100svh] items-center overflow-hidden">
      ...
      <div className="relative mx-auto w-full max-w-5xl px-5 pb-16 pt-32 text-center lg:px-8">
        ...
        <HeroWordmark />
        <p className="mx-auto mt-2 text-[11px] font-semibold uppercase tracking-[0.5em] text-foreground/80 sm:text-sm">
          Civil & Interior
        </p>
